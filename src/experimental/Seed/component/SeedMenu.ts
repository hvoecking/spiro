import template from "./SeedMenu.html?raw";
...
export type SeedModel = { [x: string]: string | number | boolean } & SeedMenuComponent;
...
export function seedMenuFactory() {
  function seedMenuComponent(this: SeedMenuComponent) {
    return {
      numericSeed: 0,
      mnemonic: "",
  ...
  return new XComponent(template, "seed-menu", seedMenuComponent);
}
